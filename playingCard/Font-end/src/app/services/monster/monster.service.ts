...
export class MonsterService {
  ...
  private init() {
    ...
    monster2.name = 'Pouk';
    monster2.hp = 80;
    monster2.image = './img/electric.png';
    monster2.type = MonsterType.PLANT;
    monster2.figureCaption = 'N°003 Pouk';
    ...
    monster3.name = 'Plauk';
    monster3.hp = 40;
    monster3.image = './img/pik.png';
    monster3.type = MonsterType.FIRE;
    monster3.figureCaption = 'N°002 Plauk';
    ...
    monster4.name = 'Plok';
    monster4.hp = 80;
    monster4.image = './img/electric.png';
    monster4.type = MonsterType.WATER;
    monster4.figureCaption = 'N°003 Plauk';
  ...
  udpate(monster: Monster): Monster {
    const monsterCopy = monster.copy();
